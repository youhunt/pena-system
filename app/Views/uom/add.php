                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" class="form-control <?php if(session('errors.uomdec')) : ?>is-invalid<?php endif ?>" id="uomdec" placeholder="<?= lang('UOM.uomdec'); ?>" name="uomdec" value="<?=  old('uomdec'); ?>">
                                            </div>
