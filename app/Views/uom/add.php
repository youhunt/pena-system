                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" step="0.00001" class="form-control <?php if(session('errors.uomdec')) : ?>is-invalid<?php endif ?>" id="uomdec" placeholder="<?= lang('UOM.uomdec'); ?>" name="uomdec" value="<?= number_format((float)(old('uomdec')), 5, '.', ''); ?>">
                                            </div>
