                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" step="0.00001" class="form-control <?php if(session('errors.value')) : ?>is-invalid<?php endif ?>" id="value" placeholder="<?= lang('ItmUOMConv.value'); ?>" name="value" value="<?=  number_format((float)(old('value') ? : $itmuomconv[0]->value), 5, '.', ''); ?>">
                                            </div>
