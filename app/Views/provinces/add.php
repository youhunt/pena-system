...
<?= $this->section('page-content') ?>
                    ...
                    <form action="<?= base_url(); ?>provinces/save" class="user" method="post">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control <?php if(session('errors.province_code')) : ?>is-invalid<?php endif ?>" id="province_code" placeholder="<?= lang('Provinces.province_code'); ?>" name="province_code" value="<?= old('province_code') ?>">
                                            </div>
                                            <label for="province_name" class="col-sm-2 col-form-label"><?= lang('Provinces.province_name'); ?></label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control <?php if(session('errors.province_name')) : ?>is-invalid<?php endif ?>" id="province_name" placeholder="<?= lang('Provinces.province_name'); ?>" name="province_name" value="<?= old('province_name') ?>">
                                            </div>
                                        </div>
