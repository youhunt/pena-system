                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" step="0.00001" class="form-control <?php if(session('errors.shelf_life')) : ?>is-invalid<?php endif ?>" id="shelf_life" placeholder="<?= lang('Item.shelf_life'); ?>" style="text-align:right;" name="shelf_life" value="<?= number_format((float)(old('shelf_life')), 5, '.', ''); ?>">
                                            </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" step="0.00001" class="form-control <?php if(session('errors.item_price')) : ?>is-invalid<?php endif ?>" id="item_price" placeholder="<?= lang('Item.item_price'); ?>" name="item_price" style="text-align:right;" value="<?= number_format((float)(old('item_price')), 5, '.', ''); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" step="0.00001" class="form-control <?php if(session('errors.item_length')) : ?>is-invalid<?php endif ?>" id="item_length" placeholder="<?= lang('Item.item_length'); ?>" name="item_length" style="text-align:right;" value="<?= number_format((float)(old('item_length')), 5, '.', ''); ?>">
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" step="0.00001" class="form-control <?php if(session('errors.out_length')) : ?>is-invalid<?php endif ?>" id="out_length" placeholder="<?= lang('Item.out_length'); ?>" name="out_length" style="text-align:right;" value="<?= number_format((float)(old('out_length')), 5, '.', ''); ?>">
                                            </div>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" step="0.00001" class="form-control <?php if(session('errors.item_width')) : ?>is-invalid<?php endif ?>" id="item_width" placeholder="<?= lang('Item.item_width'); ?>" name="item_width" style="text-align:right;" value="<?= number_format((float)(old('item_width')), 5, '.', ''); ?>">
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" step="0.00001" class="form-control <?php if(session('errors.out_width')) : ?>is-invalid<?php endif ?>" id="out_width" placeholder="<?= lang('Item.out_width'); ?>" name="out_width" style="text-align:right;" value="<?= number_format((float)(old('out_width')), 5, '.', ''); ?>">
                                            </div>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" step="0.00001" class="form-control <?php if(session('errors.item_height')) : ?>is-invalid<?php endif ?>" id="item_height" placeholder="<?= lang('Item.item_height'); ?>" name="item_height" style="text-align:right;" value="<?= number_format((float)(old('item_height')), 5, '.', ''); ?>">
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" step="0.00001" class="form-control <?php if(session('errors.out_height')) : ?>is-invalid<?php endif ?>" id="out_height" placeholder="<?= lang('Item.out_height'); ?>" name="out_height" style="text-align:right;" value="<?= number_format((float)(old('out_height')), 5, '.', ''); ?>">
                                            </div>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" step="0.00001" class="form-control <?php if(session('errors.item_diameter')) : ?>is-invalid<?php endif ?>" id="item_diameter" placeholder="<?= lang('Item.item_diameter'); ?>" name="item_diameter" style="text-align:right;" value="<?= number_format((float)(old('item_diameter')), 5, '.', ''); ?>">
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" step="0.00001" class="form-control <?php if(session('errors.out_diameter')) : ?>is-invalid<?php endif ?>" id="out_diameter" placeholder="<?= lang('Item.out_diameter'); ?>" name="out_diameter" style="text-align:right;" value="<?= number_format((float)(old('out_diameter')), 5, '.', ''); ?>">
                                            </div>
                                            <div class="col-sm-2">
