                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" class="form-control <?php if(session('errors.shelf_life')) : ?>is-invalid<?php endif ?>" id="shelf_life" placeholder="<?= lang('Item.shelf_life'); ?>" style="text-align:right;" name="shelf_life" value="<?= old('shelf_life') ?>">
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" class="form-control <?php if(session('errors.item_diameter')) : ?>is-invalid<?php endif ?>" id="item_diameter" placeholder="<?= lang('Item.item_diameter'); ?>" name="item_diameter" value="<?= old('item_diameter') ?>">
                                            </div>
                                        </div>
