                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" class="form-control <?php if(session('errors.shelf_life')) : ?>is-invalid<?php endif ?>" id="shelf_life" placeholder="<?= lang('Item.shelf_life'); ?>" name="shelf_life" value="<?= old('shelf_life') ?>">
                                            </div>
