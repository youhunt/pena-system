...
<?= $this->section('page-content') ?>
                    <form action="<?= base_url(); ?>costtype/save" class="user" method="post">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?php if(session('errors.description')) : ?>is-invalid<?php endif ?>" id="comp_code" placeholder="<?= lang('CostType.description'); ?>" name="description" value="<?= old('description'); ?>">
                                            </div>
                                        </div>
