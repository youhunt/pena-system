                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control <?php if(session('errors.loc_add')) : ?>is-invalid<?php endif ?>" rows="2" placeholder="<?= lang('Location.loc_add'); ?>" name="loc_add"><?= old('loc_add') ?></textarea>
                                            </div>
                                        </div>
