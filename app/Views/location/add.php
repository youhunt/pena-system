                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="hidden" id="whs_code" name="whs_code" value="<?= old('whs_code'); ?>" />
                                                <select class="form-control <?php if(session('errors.whs_code')) : ?>is-invalid<?php endif ?>" name="whs" id="whs" >
                                                    <option selected="selected"><?= old('whs'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?php if(session('errors.loc_code')) : ?>is-invalid<?php endif ?>" id="loc_code" placeholder="<?= lang('Location.loc_code'); ?>" name="loc_code" value="<?= old('loc_code') ?>">
                                            </div>
                                            <label for="loc_pic" class="col-sm-2 col-form-label"><?= lang('Location.loc_pic'); ?></label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?php if(session('errors.loc_pic')) : ?>is-invalid<?php endif ?>" id="loc_pic" placeholder="<?= lang('Location.loc_pic'); ?>" name="loc_pic" value="<?= old('loc_pic') ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?php if(session('errors.loc_name')) : ?>is-invalid<?php endif ?>" id="loc_name" placeholder="<?= lang('Location.loc_name'); ?>" name="loc_name" value="<?= old('loc_name') ?>">
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control <?php if(session('errors.loc_add')) : ?>is-invalid<?php endif ?>" rows="3" placeholder="<?= lang('Location.loc_add'); ?>" name="loc_add"><?= old('loc_add') ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="hidden" id="loc_count" name="loc_count" value="" />
                                            ...
                                            <div class="col-sm-4">
                                                <input type="hidden" id="loc_prov" name="loc_prov" value="" />
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="hidden" id="loc_city" name="loc_city" value="" />
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?php if(session('errors.loc_post')) : ?>is-invalid<?php endif ?>" id="loc_post" placeholder="<?= lang('Location.loc_post'); ?>" name="loc_post" value="<?= old('loc_post') ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?php if(session('errors.loc_phone1')) : ?>is-invalid<?php endif ?>" id="loc_phone1" placeholder="<?= lang('Location.loc_phone1'); ?>" name="loc_phone1" value="<?= old('loc_phone1') ?>">
                                            </div>
                                            <label for="loc_phone2" class="col-sm-2 col-form-label"><?= lang('Location.loc_phone2'); ?></label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?php if(session('errors.loc_phone2')) : ?>is-invalid<?php endif ?>" id="loc_phone2" placeholder="<?= lang('Location.loc_phone2'); ?>" name="loc_phone2" value="<?= old('loc_phone2') ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?php if(session('errors.loc_phone3')) : ?>is-invalid<?php endif ?>" id="loc_phone3" placeholder="<?= lang('Location.loc_phone3'); ?>" name="loc_phone3" value="<?= old('loc_phone3') ?>">
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="hidden" id="whs_dcount" name="whs_dcount" value="" />
                                                <select class="form-control <?php if(session('errors.whs_dcount')) : ?>is-invalid<?php endif ?>" name="bcountry" id="bcountry" ></select>
                                            </div>
                                            <label for="whs_dprov" class="col-sm-2 col-form-label"><?= lang('Location.whs_dprov'); ?></label>
                                            <div class="col-sm-4">
                                                <input type="hidden" id="whs_dprov" name="whs_dprov" value="" />
                                                <select class="form-control <?php if(session('errors.whs_dprov')) : ?>is-invalid<?php endif ?>" name="bprov" id="bprov" ></select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="hidden" id="whs_dcity" name="whs_dcity" value="" />
                                                <select class="form-control <?php if(session('errors.whs_dcity')) : ?>is-invalid<?php endif ?>" name="bcity" id="bcity" ></select>
                                            </div>
                                            <label for="whs_dpost" class="col-sm-2 col-form-label"><?= lang('Location.whs_dpost'); ?></label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?php if(session('errors.whs_dpost')) : ?>is-invalid<?php endif ?>" id="whs_dpost" placeholder="<?= lang('Location.whs_dpost'); ?>" name="whs_dpost" value="<?= old('whs_dpost') ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?php if(session('errors.whs_dphone1')) : ?>is-invalid<?php endif ?>" id="whs_dphone1" placeholder="<?= lang('Location.whs_dphone1'); ?>" name="whs_dphone1" value="<?= old('whs_dphone1') ?>">
                                            </div>
                                            <label for="whs_dphone2" class="col-sm-2 col-form-label"><?= lang('Location.whs_dphone2'); ?></label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?php if(session('errors.whs_dphone2')) : ?>is-invalid<?php endif ?>" id="whs_dphone2" placeholder="<?= lang('Location.whs_dphone2'); ?>" name="whs_dphone2" value="<?= old('whs_dphone2') ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?php if(session('errors.whs_dphone3')) : ?>is-invalid<?php endif ?>" id="whs_dphone3" placeholder="<?= lang('Location.whs_dphone3'); ?>" name="whs_dphone3" value="<?= old('whs_dphone3') ?>">
                                            </div>
