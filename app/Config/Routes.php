...
$routes->post('work_center/getWorkCenterChild', 'WorkCenter::getWorkCenterChild', ['filter' => 'role:administrator']);
$routes->post('work_center/saveChild', 'WorkCenter::saveChild', ['filter' => 'role:administrator']);
$routes->post('work_center/updateChild', 'WorkCenter::updateChild', ['filter' => 'role:administrator']);
$routes->post('work_center/deleteChild', 'WorkCenter::deleteChild', ['filter' => 'role:administrator']);
$routes->post('work_center/getWorkCenterChildById', 'WorkCenter::getWorkCenterChildById', ['filter' => 'role:administrator']);
