...
class Warehouse extends BaseController
{
    ...
    {        
        ...
        $data['dept_name'] = $data['whs'][0]->dept_code ? $dataDep->getDepartment($data['whs'][0]->dept_code)[0]->dept_code."|".$dataDep->getDepartment($data['whs'][0]->dept_code)[0]->dept_name : "";
        $data['site_name'] = $data['whs'][0]->site_code ? $dataSit->getSite($data['whs'][0]->site_code)[0]->site_code."|".$dataSit->getSite($data['whs'][0]->site_code)[0]->site_name : "";
        $data['comp_name'] = $data['whs'][0]->comp_code ? $dataCom->getCompany($data['whs'][0]->comp_code)[0]->comp_code."|".$dataCom->getCompany($data['whs'][0]->comp_code)[0]->comp_name : "";
        $data['count_name'] = $data['whs'][0]->whs_count ? $dataCou->getCountries($data['whs'][0]->whs_count)[0]->country_code."|".$dataCou->getCountries($data['whs'][0]->whs_count)[0]->country_name : "";
        $data['bcount_name'] = $data['whs'][0]->whs_bcount ? $dataCou->getCountries($data['whs'][0]->whs_bcount)[0]->country_code."|".$dataCou->getCountries($data['whs'][0]->whs_bcount)[0]->country_name : "";
        $data['mcount_name'] = $data['whs'][0]->whs_mcount ? $dataCou->getCountries($data['whs'][0]->whs_mcount)[0]->country_code."|".$dataCou->getCountries($data['whs'][0]->whs_mcount)[0]->country_name : "";
        $data['prov_name'] = $data['whs'][0]->whs_prov ? $dataPro->getProvinces($data['whs'][0]->whs_prov)[0]->province_code."|".$dataPro->getProvinces($data['whs'][0]->whs_prov)[0]->province_name : "";
        $data['bprov_name'] = $data['whs'][0]->whs_bprov ? $dataPro->getProvinces($data['whs'][0]->whs_bprov)[0]->province_code."|".$dataPro->getProvinces($data['whs'][0]->whs_bprov)[0]->province_name : "";
        $data['mprov_name'] = $data['whs'][0]->whs_mprov ? $dataPro->getProvinces($data['whs'][0]->whs_mprov)[0]->province_code."|".$dataPro->getProvinces($data['whs'][0]->whs_mprov)[0]->province_name : "";
        $data['city_name'] = $data['whs'][0]->whs_city ? $dataCit->getCities($data['whs'][0]->whs_city)[0]->city_code."|".$dataCit->getCities($data['whs'][0]->whs_city)[0]->city_name : "";
        $data['bcity_name'] = $data['whs'][0]->whs_bcity ? $dataCit->getCities($data['whs'][0]->whs_bcity)[0]->city_code."|".$dataCit->getCities($data['whs'][0]->whs_bcity)[0]->city_name : "";
        $data['mcity_name'] = $data['whs'][0]->whs_mcity ? $dataCit->getCities($data['whs'][0]->whs_mcity)[0]->city_code."|".$dataCit->getCities($data['whs'][0]->whs_mcity)[0]->city_name : "";
        $data['title_meta'] = view('partials/title-meta', ['title' => 'Warehouse']);
        $data['page_title'] = view('partials/page-title', ['title' => 'Warehouse', 'pagetitle' => 'MasterData']);
