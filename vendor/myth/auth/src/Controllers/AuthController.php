...
class AuthController extends Controller
{
    ...
    public function login()
    {
        ...
        return $this->_render($this->config->views['login'], ['config' => $this->config, 'title_meta' => view('partials/title-meta', ['title' => 'Login']),
			'page_title' => view('partials/page-title', ['title' => 'Login', 'pagetitle' => 'Login']) ]);
    }
