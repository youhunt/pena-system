    ...
    columns: [
      {
        ...
        render: function (data, type, full) {
          return (
            '<div class="d-none">' +
            full.id +
            '</div><div class="avatar-sm bg-light rounded p-2">\
                    <img src="' +
            full.projectLogoImg +
          ...
          return (
            '<div class="dropdown">\
                ...
                <ul class="dropdown-menu dropdown-menu-end">\
                    <li><a href="projects-create.html" class="dropdown-item edit-list" data-edit-id="' +
            full.id +
...
function tooltipElm() {
  ...
  var tooltipList = []
    .concat(_toConsumableArray(tooltipTriggerList))
