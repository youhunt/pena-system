          ...
          return (
            ...
            '</div>\
                    <div class="form-check font-size-16">\
                        <input class="form-check-input" type="checkbox" id="customerlistcheck-' +
            full.id +
            '">\
          ...
          return (
            '<div class="dropdown">\
                ...
                <ul class="dropdown-menu dropdown-menu-end">\
                    <li><a href="#newCustomerModal" data-bs-toggle="modal" class="dropdown-item edit-list" data-edit-id="' +
            full.id +
            '"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>\
                    <li><a href="#removeItemModal" data-bs-toggle="modal" class="dropdown-item remove-list" data-remove-id="' +
            full.id +
...
function findNextId() {
  ...
  var lastElementId = fetchIdFromObj(
      customerListData[customerListData.length - 1]
    ),
...
// add list event
Array.from(document.querySelectorAll(".addCustomers-modal")).forEach(function (
  elem
) {
  elem.addEventListener("click", function (event) {
    editList = false;
