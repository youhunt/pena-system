    ...
    columns: [
      {
        ...
        render: function (data, type, full) {
          var isUserProfile = full.memberImg
            ? '<img src="' +
              full.memberImg +
      ...
      },
      {
        ...
        render: function (data, type, full) {
          return (
            '<div>\
                    <h5 class="text-truncate font-size-14 mb-1"><a href="javascript: void(0);" class="text-dark">' +
            full.userName +
            '</a></h5>\
            ...
            '<ul class="list-inline font-size-20 contact-links mb-0">\
                    ...
                    <div class="dropdown">\
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">\
                            <li><a href="#newContactModal" data-bs-toggle="modal" class="dropdown-item edit-list" data-edit-id="' +
            full.id +
