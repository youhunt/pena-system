  ...
  for (
    ...
    if (datas[i]) {
      ...
      Array.from(datas[i].requirement).forEach(function (tag, index) {
        ...
        tagHtmlValue +=
          '<span class="badge rounded-1 ' + tagClass + '">' + tag + "</span>";
      });
      ...
      document.querySelector("#jobgrid-list").innerHTML +=
        ...
        <div class="card">\
            <div class="card-body">\
                <img src="' +
        datas[i].image +
        '" alt="" height="50" class="mb-3">\
                <h5 class="fs-17 mb-2"><a href="javascript:void(0);" class="text-dark">' +
        datas[i].jobTitle +
...
$("#datepicker1 input")
  ...
  .on("changeDate", function (e) {
    ...
    for (var i = 1; i < dataPageNum + 1; i++) {
      pageNumber.innerHTML +=
        "<a class='page-link clickPageNumber' href='#'>" + i + "</a>";
    }
