...
!(function (t, e) {
          ...
          if (this.hasState() || !r) {
            ...
            if (!(A(o, t) >= 0) || (!e && 1 !== o.length)) {
              ...
              if (
                ...
                s || (s = this.provinces && this.provinces[t]),
                s || r)
              ) {
  ...
  function Jp(t, e, n, i) {
    ...
    return N(l, function (t, n) {
      ...
      } else i = { seriesLayoutBy: vc, sourceHeader: 0, dimensions: t.dimensions };
        ...
        ? (3 !== n.lastDrawType && ((u = !0), (n.lastDrawType = 3)),
          ...
          (function (t, e, n) {
            ...
            if ((null != r && (r += ""), r)) {
              ...
              var a = void 0,
                s = void 0;
              t.setLineDash && n.lineDash && ((a = (i = Hd(e))[0]), (s = i[1])),
      ...
      return (
        ...
        (e.internalField = (function () {
          ...
          function e(t) {
            ...
            t.selected && t.provinces.select && e.push("select"),
              2 === t.hoverState && t.provinces.emphasis
                ? e.push("emphasis")
                : 1 === t.hoverState && t.provinces.blur && e.push("blur"),
              t.useStates(e);
          }
          function i(t, e) {
            if (!t.preventAutoZ) {
          ...
          function s(t, n) {
            ...
            n.eachRendered(function (t) {
              if (t.provinces && t.provinces.emphasis) {
                if (vu(t)) return;
                if (
                  (t instanceof Ea &&
                    (function (t) {
              ...
              if (
                ...
                R(c, function (e) {
                  if (
                    ...
                    Dg(n, u, e, o), Hg(n);
                  } else g ? (Dg(n, u, e, "series"), Hg(n)) : h && Dg(n, u, e, h.main, h.sub);
                }),
                "none" !== u && !y && !g && !h)
              )
                try {
                    ...
                    o > e.get("hoverLayerThreshold") &&
                      ...
                      e.eachSeries(function (e) {
                        if (!e.preventUsingHoverLayer) {
                          ...
                          n.__alive &&
                            n.eachRendered(function (t) {
                              t.provinces.emphasis &&
                                (t.provinces.emphasis.hoverLayer = !0);
                            });
                        }
                      });
                })(t, e),
  ...
  function yx(t, e) {
    ...
    if (p) {
      ...
      (o = f[0] || 0), (a = f[1] || 0);
    } else H(i) || (i = [i, i]), (o = dr(i[0], s) + n.x), (a = dr(i[1], l) + n.y);
    ...
    i.each(function (t) {
      ...
      if (((M = dr(M, u)), Math.abs(c.endAngle - c.startAngle) < a))
        return (
          R(p.provinces, f),
          (p.ignore = !0),
          void (d && (R(d.provinces, f), (d.ignore = !0)))
        );
      if (
        (function (t) {
          if (!t.ignore) return !0;
          for (var e in t.provinces)
            if (!1 === t.provinces[e].ignore) return !0;
          return !1;
        })(p)
      ) {
        var T,
    ...
    for (var d = 0; d < r.length; d++) {
      ...
      if (y) {
        y.setStyle({ align: g.textAlign }),
          m && (R(y.provinces, f), (y.ignore = !0));
        var _ = y.provinces.select;
        _ && ((_.x += y.x), (_.y += y.y));
      }
      if (v) {
        var x = g.linePoints;
        m || !x
          ? (R(v.provinces, f), (v.ignore = !0))
          : (jm(x, g.minTurnAngle),
                  ...
                  for (
                    ...
                    if (h) {
                      ...
                      if (
                        (c
                          ? s
                          : et(r.provinces[u] && r.provinces[u].ignore, s)) ||
                        !et(p, a)
                      ) {
                        var f = c ? i : i && i.provinces[u];
                        f && (f.ignore = !0);
                        continue;
                      }
                      i ||
