...
!(function () {
  ...
  class Ba {
    ...
    add(e) {
      ...
      return (
        t.queue.push(e),
        void 0 === t.provinces[e] && (t.provinces[e] = 0),
        new Promise((n, o) => {
    ...
    remove(e) {
      delete this.provinces[e], delete this.scriptLoadedCallbacks[e];
    }
    loadQueue() {
      const e = this.queue;
              ...
              2 === t.provinces[e]
                ...
                : ((t.provinces[e] = 1),
                  t.loadScript(e).then(
                    ...
                    () => (
                      (t.provinces[e] = 3), n("reject", e), Promise.reject(e)
                    )
                  ))
            )
          ),
